# -*- coding: utf-8 -*-
"""
Created on Sat Oct  7 19:52:38 2023
...
folder_path = r"E:\Personal Data\Nbo2\09 Sept\10072023\229"
...
for file_num, csv_file in enumerate(csv_files, start=1):
    ...
    #
    # Plot the line
    plt.plot( current_np, voltage_np, label=f'Run {file_num}',marker= '.', linestyle='-',  color = 'red', linewidth=1)
